...
//userid=1&phone=1234&user_name=f&sex=1&addr=bj&totalprice=45&cartDetail=[{"ctid":"11","did":"1","dishCount":"2","name":"【酸甜开胃虾】","img_sm":"p0281.jpg","price":"36.00"}]&did=1
*输出结果：
...
if(empty($userid) || empty($user_name) || empty($phone)|| empty($sex) || empty($addr) || empty($totalprice)|| empty($did) || empty($cartDetail)){
...
$sql = "insert into kf_order values(null,'$userid','$phone','$user_name','$sex','$order_time','$addr','$totalprice','$did')";
